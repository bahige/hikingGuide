...
export const fetchSingleUserRequest = (userId) => {
    return {type: FETCH_SINGLE_USER_REQUEST, payload : userId};
}

export const fetchSingleUserSuccess = (data) => {
    return {type: FETCH_SINGLE_USER_SUCCESS,         
        payload:data
    };
}

export const fetchSingleUserFailure = (error) => {
    return {type: FETCH_SINGLE_USER_FAILURE, payload:error};
}

export const fetchSingleUser = (userId) => async (dispatch) => {
    try{ 
        dispatch(fetchSingleUserRequest(userId));
