...
import { displayToursOfTourOrganizer } from '../../redux/organizer/organizerActions';




const ToursListByOrganizer = (props) => {
    ...
    const hikingLevelOptions= [
     ...
     const handlePageChange = (currentPage) =>{
         ...
         dispatch(displayToursOfTourOrganizer(searchKeyword, governorate, date, currentPage, postsPerPage))
     }

     useEffect(() => {
            dispatch(displayToursOfTourOrganizer(props.match.params.orgId, searchKeyword, governorate, hikingLevel, date, currentPage, postsPerPage));  
     ...
     const searchHandler = (e) => {
         ...
         setCurrentPage(1);
         dispatch(displayToursOfTourOrganizer(props.match.params.orgId, searchKeyword, currentPage, postsPerPage));
     }
     ...
     const itemsPerPageHandler =(e) => {
         ...
         setCurrentPage(1);
         dispatch(displayToursOfTourOrganizer(orgId, searchKeyword, governorate, date, hikingLevel, currentPage, postsPerPage));
     }
     ...
     const governorateHandler =(e) => {
        ...
        setCurrentPage(1);
        dispatch(displayToursOfTourOrganizer(orgId, governorate, currentPage, postsPerPage));
    }
    ...
    const hikingLevelHandler =(e) => {
        ...
        setCurrentPage(1);
        dispatch(displayToursOfTourOrganizer(orgId, hikingLevel, currentPage, postsPerPage));
    }
    ...
    const dateHandler =(e) => {
        ...
        setCurrentPage(1);
        dispatch(displayToursOfTourOrganizer(orgId, date, currentPage, postsPerPage));
    }
...
export default ToursListByOrganizer
